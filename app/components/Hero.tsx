...
const Hero:React.FC = () => {
  ...
  return (
    <section id='home' className='w-full h-screen md:h-auto bg-blac pt-28 lg:pt-40 pb-3.5 flex flex-col items-center justify-between relative overflow-hidden'>
      <div className='container mx-auto mb- md:mb-14 lg:mb-8'>
        <div>
          <motion.h1
      ...
      <div className='w-full'>
        <motion.h1 
          initial={{ x: 0 }}
          animate={{ x: '-190%' }}
          transition={{ repeat: Infinity, repeatType: 'mirror', duration: 30, delay: 0.5 }}
          className='text-[70px] text-[#f5e7d376] font-serif md:text-[80px] lg:text-[120px] whitespace-nowrap font-bold'
        >
          I build user interfaces for web applications.
        </motion.h1>
      </div>
    </section>
  )
