...
const Header:React.FC = () => {
  ...
  return (
    <header className='overflow-x-hidden relative'>
      <div className='container mx-auto py-4 px-2.5 flex items-center justify-between'>
        ...
        <nav className={`w-[70%] md:w-[50%] lg:w-auto h-screen lg:h-auto bg-white lg:bg-transparent text-black lg:text-white fixed lg:static top-0 right-0 pt-5 duration-300 ease-in-out lg:translate-x-0 ${showMenu ? 'translate-x-0' : 'translate-x-full'} z-20`}>
        ...
        <div className='flex items-center gap-12'>
          ...
          <div onClick={() => setShowMenu(!showMenu)} className='cursor-pointer z-40'>
