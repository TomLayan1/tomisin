...
const Footer:React.FC = () => {
  ...
  return (
    <section id='contact' className='w-full pt-14 pb-7'>
      <div className='container w-[90%] lg:w-[80%] mx-auto'>
        <div className='flex flex-col-reverse lg:flex-row lg:justify-between mb-48'>
          <div className='w-[20%]'>
            <div className='flex lg:flex-col justify-evenly lg:block'>
          ...
          <div className='lg:w-[50%] mb-10 lg:mb-0 flex flex-col items-center lg:block'>
            <h1 className='text-2xl md:text-3xl lg:text-4xl font-bold justify-evenly mb-6 text-center lg:text-left'>Have a question? Interested in my service? Hit me up.</h1>
            <a href='mailto:dev.tomisin@gmail.com' target='_blank' rel='noopener noreferrer'>
              <button className='w-[300px] border py-2 hover:bg-[#f5e7d333] cursor-pointer duration-200'>Email me</button>
            </a>
          </div>
        </div>
        <div className='flex items-center justify-between'>
          <div>
            <p className='text-[15px] text-center lg:text-left'>Tomisin Afolayan</p>
            <p className='text-[15px] text-center lg:text-left'>All Rights Reserved &copy; 2025</p>
          </div>
          <div>
