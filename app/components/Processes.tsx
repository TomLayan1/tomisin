...
const Processes:React.FC = () => {
  ...
  return (
    <section className='w-full bg-black py-8'>
      <h1 className='text-3xl md:text-5xl text-center mb-12'>Working Process</h1>
      <div className='container w-[90%] mx-auto grid md:grid-cols-4 gap-11 perspective'>
        {workProcess?.map((item, i) => (
          <motion.div
            ...
            // viewport={{ once: true }}
            key={i}
            className='bg-gradient-to-br from-gray-700 to-purple-300 p-1'
          >
            <div className='h-full bg-black p-5 flex flex-col gap-3.5'>
              {item.icon}
